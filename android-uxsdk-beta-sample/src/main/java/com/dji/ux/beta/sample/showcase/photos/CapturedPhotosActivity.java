package com.dji.ux.beta.sample.showcase.photos;
...
public class CapturedPhotosActivity extends Activity implements View.OnClickListener {

    private static final String TAG = CapturedPhotosActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.captured_photos);
        initUI();
    }
...
//        });
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(CapturedPhotosActivity.this, RecyclerView.VERTICAL,false);
        ...
        //Init Loading Dialog
        mLoadingDialog = new ProgressDialog(CapturedPhotosActivity.this);
        mLoadingDialog.setMessage("Please wait");
        mLoadingDialog.setCanceledOnTouchOutside(false);
        mLoadingDialog.setCancelable(false);

        //Init Download Dialog
        mDownloadDialog = new ProgressDialog(CapturedPhotosActivity.this);
    ...
    private void setResultToToast(final String result) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(CapturedPhotosActivity.this, result, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setResultToText(final String string) {
        ...
        CapturedPhotosActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
